<%-- 
    Document   : expert
    Created on : Jun 1, 2022, 1:37:40 PM
...
<body>
	...
	<header class="py-3">
		<div class="container">
			<div id="logo">
				<h1> <a href="index.html"><span class="fa fa-solid fa-tooth" aria-hidden="true"></span> Nha Khoa Thiên
						Thần </a></h1>
			</div>
			<!-- nav -->
			<nav class="d-lg-flex">
				...
				<ul class="menu mt-2 ml-auto">
					...
					<li class=""><a href="knowledge.html">KiẾN THỨC</a></li>
					<li class=""><a href="expert.html">CHUYÊN GIA</a></li>
					<li class=""><a href="booking.html">ĐẶT LỊCH</a></li>
				</ul>
				<div class="login-icon ml-2">
					<a class="user" href="booking.html"> LOGIN </a>
				</div>
			</nav>
			<div class="clear"></div>
			<!-- //nav -->
